...
- **Participates in**: `inner-loop`, `pr`, `release` _(derived from working-state `roles`)_
...
- **Participates in**: `incident-response`, `release` _(derived from working-state `roles`)_
...
- **Participates in**: `config-change`, `data-change`, `incident-response`, `mitigation` _(derived from working-state `roles`)_
